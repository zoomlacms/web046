...
<form id="form1" runat="server">
    ...
    <div class="m_top">
                            ...
                            <div id="Announce">
                                ...
                                <div class="dropdown pull-right topdrop">
                                    <a data-toggle="dropdown" class="dropdown-toggle" href="javascript:;" aria-expanded="false">
                                        <span runat="server" id="nameL"></span> <i class="fa fa-caret-down"></i>
                                    </a>
        ...
        <div class="m_top_bottom hidden-xs">
            <ul class="menu1 open">
                ...
                <li class="menu1_5"><a onclick="showleft('menu1_1','Workload/FuncList.aspx')">功能列表</a></li>
       ...
       <%--                     <li><a href="javascript:;" onclick="showleft('menu2_4','Pub/PubExcel.aspx')"><%=Resources.L.Excel导出 %></a></li>--%>
            ...
            <ul class="menu5">
                ...
                <li class="menu5_10"><a onclick="showleft('menu5_10','Content/Font/Default.aspx')">字体大师</a></li>
            </ul>
            <ul class="menu6">
            ...
            <ul class="menu7">
                ...
                <li class="menu7_5"><a onclick="showleft('menu7_5','File/FtpAll.aspx')"><%=Resources.L.文件管理 %></a></li>
                ...
                <li class="menu9_8"><a onclick="showleft('menu9_8','Plus/Log/LogManage.aspx?LogType=4')"><%=Resources.L.日志管理 %></a></li>
            </ul>
            <ul class="menu8">
            ...
            <ul class="menu9">
                ...
                <li class="menu9_4"><a onclick="showleft('menu9_4','/AdminMVC/CRM/Index')"><%=Resources.L.CRM管理 %></a></li>
    ...
    <div class="m_main">
        ...
        <li id="menu3_8_8"><a href="javascript:;" data-url="Boss/PromoBonus.aspx">推广佣金</a></li>--%>
            ...
            <ul class="list-unstyled">
                ...
                <div id="menu5" class="m_left_ul">
                    ...
                    <ul class="list-unstyled m_left_ulin" id="menu5_10">
                        <li class="menu_tit"><span class="fa fa-chevron-down"></span>字体管理</li>
                ...
                <div id="menu7" class="m_left_ul">
                    ...
                    <ul class="m_left_ulin" id="menu7_2">
                        <li>
                            <p class="bg-info laybtn"><i class="fa fa-arrow-circle-down"></i> 广告管理</p>
                            <ul>
                        ...
                        <li>
                            <p class="bg-info laybtn"><i class="fa fa-arrow-circle-down"></i> 名片设计</p>
                            <ul class="list-unstyled">
		...
		<li id="menu9_2_4"><a href="javascript:;" data-url="AddOn/StructAnalysis.aspx"><%=Resources.L.分析结构%></a></li>--%>
                ...
                <div id="menu10" class="m_left_ul">
                    ...
                    <ul class="m_left_ulin" id="menu10_3">
                        ...
                        <li>
                            <p class="bg-info laybtn"><i class="fa fa-arrow-circle-down"></i>联网打印</p>
                            <ul class="list-unstyled">
                        ...
                        <li>
                            <p class="bg-info laybtn"><i class="fa fa-arrow-circle-down"></i>在线监控</p>
                            <ul class="list-unstyled">
        ...
        <div id="leftSwitch" class="hidden-xs hidden-sm" onclick="hideleft();">
