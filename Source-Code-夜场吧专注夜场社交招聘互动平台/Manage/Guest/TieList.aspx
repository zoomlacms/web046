...
<asp:Content ContentPlaceHolderID="Content" runat="Server">
    ...
    <div class="panel panel-default" style="padding: 0px;">
        ...
        <div class="panel panel-footer" style="padding: 3px; margin: 0px;">
            <asp:Button ID="btndelete" runat="server" CssClass="btn btn-info" OnClientClick="return confirm('确定要删除选中的项目吗？')" Text="批量删除" OnClick="btndelete_Click" />
            <asp:Button ID="Rels" runat="server" CssClass="btn btn-info" Text="批量还原" OnClick="Rels_Click" />
            <asp:Button ID="Check_B" runat="server" CssClass="btn btn-info" Text="批量审核" OnClick="Check_B_Click" />
            <asp:Button ID="UnCheck_B" runat="server" CssClass="btn btn-info" Text="取消审核" OnClick="UnCheck_B_Click" />
            <asp:Button ID="DelAll" runat="server" Visible="false" CssClass="btn btn-info" OnClientClick="return delAll()" Text="清空回收站" OnClick="btndelete_Click" />
            <span id="Opiton_Span" runat="server" visible="false">
                <asp:Button ID="BtnAddMedalPosation" runat="server" Text="颁发勋章" CssClass="btn btn-info" OnClick="BtnAddMedalPosation_Click" />
                <asp:Button ID="BtnSetAllTopPosation" runat="server" CssClass="btn btn-info" Text="全局置顶" OnClick="BtnSetAllTopPosation_Click" />
                <asp:Button ID="BtnSetTopPosation" runat="server" CssClass="btn btn-info" Text="版面置顶" OnClick="BtnSetTopPosation_Click" />
                <asp:Button ID="BtnClosTopPosation" runat="server" CssClass="btn btn-info" Text="取消置顶" OnClick="BtnClosTopPosation_Click" />
                <asp:Button ID="BtnSetRecomPosation" runat="server" CssClass="btn btn-info" Text="设为精华" OnClick="BtnSetRecomPosation_Click" />
                <asp:Button ID="BtnCloseRecomPosation" runat="server" CssClass="btn btn-info" Text="取消精华" OnClick="BtnCloseRecomPosation_Click" />
                <asp:Button ID="BtnSetDown" runat="server" CssClass="btn btn-info" Text="沉底贴子" OnClick="BtnSetDown_Click" />
                <asp:Button ID="BtnCloseDown" runat="server" CssClass="btn btn-info" Text="取消沉底" OnClick="BtnCloseDown_Click" />
                <button type="button" onclick="ShowBarInfo()" class="btn btn-info">移动版块</button>
            </span>
    ...
    <script type="text/javascript" src="/JS/Controls/ZL_Dialog.js?v=1"></script>
    <script>
